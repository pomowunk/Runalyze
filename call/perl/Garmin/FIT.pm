## from https://github.com/mrihtar/Garmin-FIT/blob/master/Garmin/FIT.pm v0.33
package Garmin::FIT;
...
%msgtype_by_name =
  (
   ...
   'session' => +{
     ...
     78 => +{'name' => 'total_active_time', 'scale' => 1000, 'unit' => 's'}, # pure swimming/activity time without "LAP" button pause/rest
   ...
   'record' => +{
     ...
     114 => +{'name' => 'grit'}, # MTB Dynamics - Grit
     115 => +{'name' => 'flow'}, # MTB Dynamics - Flow
