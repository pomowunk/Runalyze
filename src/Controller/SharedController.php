...
class SharedController extends AbstractController
{
     ...
     */
    public function oldSharedUserAction($username): Response
    {
     ...
     */
    public function sharedUserAction($username, ParameterBagInterface $parameterBag): Response {
     ...
     */
    public function publicUserFeedAction($username, Feed $feed): Response
    {
        $account = $this->accountRepository->findByUsername($username);
        $privacy = $this->configurationManager->getList($account)->getPrivacy();
