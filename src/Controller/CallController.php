...
{
    protected string $garminApiKey;

    public function __construct(string $garminApiKey)
    {
     ...
     */
    public function dataBrowserAction(ParameterBagInterface $parameterBag, TokenStorageInterface $tokenStorage): Response
    {
     ...
     * @Security("is_granted('ROLE_USER')")
     */
    public function garminCommunicatorAction(): Response
    {
     ...
     * @Security("is_granted('ROLE_USER')")
     */
    public function savePngAction(): Response
    {
     ...
     * @Security("is_granted('ROLE_USER')")
     */
    public function windowConfigAction(ParameterBagInterface $parameterBag, TokenStorageInterface $tokenStorage): Response
    {
        $Frontend = new \Frontend($parameterBag, true, $tokenStorage);
     ...
     * @Security("is_granted('ROLE_USER')")
     */
    public function ajaxChanceConfigAction(ParameterBagInterface $parameterBag, TokenStorageInterface $tokenStorage): Response
    {
        $Frontend = new \Frontend($parameterBag, true, $tokenStorage);
     ...
     * @Security("is_granted('ROLE_USER')")
     */
    public function windowSearchAction(ParameterBagInterface $parameterBag, TokenStorageInterface $tokenStorage): Response
    {
    ...
    protected function getPlotSumData(): PlotSumData
    {
     ...
     */
    public function windowsPlotSumDataAction(ParameterBagInterface $parameterBag, TokenStorageInterface $tokenStorage): Response
    {
        $Frontend = new \Frontend($parameterBag, false, $tokenStorage);
