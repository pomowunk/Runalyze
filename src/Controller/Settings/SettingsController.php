...
class SettingsController extends AbstractController
{
    ...
    protected function exampleTagID(Account $account, TagRepository $tagRepository): string
    {
    ...
    protected function exampleEquipmentIDs(Account $account, EquipmentRepository $equipmentRepository): string
    {
        $ids = [];
