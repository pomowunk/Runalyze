...
use App\Entity\Adapter\TrackDataAdapter;
 ...
 * @ORM\Entity(repositoryClass="App\Repository\TrackdataRepository")
 */
class Trackdata implements AccountRelatedEntityInterface
{
     ...
     * @ORM\OneToOne(targetEntity="App\Entity\Training", inversedBy="trackdata")
     * @ORM\JoinColumns({
