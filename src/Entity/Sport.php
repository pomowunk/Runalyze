...
class Sport implements IdentifiableEntityInterface, NamedEntityInterface, AccountRelatedEntityInterface
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="App\Entity\EquipmentType")
     * @ORM\JoinColumns({
     ...
     * @var Account
     *
     * @ORM\ManyToOne(targetEntity="App\Entity\Account", inversedBy="sports")
     * @ORM\JoinColumns({
     ...
     *
     * @ORM\ManyToMany(targetEntity="App\Entity\EquipmentType", mappedBy="sport")
     */
     ...
     *
     * @ORM\OneToMany(targetEntity="App\Entity\Type", mappedBy="sport", fetch="EXTRA_LAZY")
     */
    protected $types;
     ...
     * @var \Doctrine\Common\Collections\Collection
     *
     * @ORM\OneToMany(targetEntity="App\Entity\Training", mappedBy="sport", cascade={"persist"}, fetch="EXTRA_LAZY")
     */
    protected $trainings;
