...
use App\Entity\Adapter\ActivityAdapter;
...
class Training implements IdentifiableEntityInterface, AccountRelatedEntityInterface
{
     ...
     * @ORM\ManyToOne(targetEntity="App\Entity\Sport", inversedBy = "trainings")
     ...
     * @var \App\Entity\Type
     *
     * @ORM\ManyToOne(targetEntity="App\Entity\Type", inversedBy = "trainings")
     ...
     * @var Trackdata|null
     *
     * @ORM\OneToOne(targetEntity="App\Entity\Trackdata", mappedBy="activity")
     */
    private $trackdata;
     ...
     * @var Swimdata|null
     *
     * @ORM\OneToOne(targetEntity="App\Entity\Swimdata", mappedBy="activity")
     */
    private $swimdata;
     ...
     * @var Hrv|null
     *
     * @ORM\OneToOne(targetEntity="App\Entity\Hrv", mappedBy="activity")
     */
    private $hrv;
     ...
     * @var Raceresult|null
     *
     * @ORM\OneToOne(targetEntity="App\Entity\Raceresult", mappedBy="activity")
     */
    private $raceresult;
