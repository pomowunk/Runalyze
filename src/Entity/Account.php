...
class Account implements UserInterface, \Serializable, IdentifiableEntityInterface
{
     ...
     *
     * @ORM\OneToMany(targetEntity="App\Entity\Sport", mappedBy="account", cascade={"persist"}, fetch="EXTRA_LAZY")
     */
    protected $sports;
     ...
     * @var \Doctrine\Common\Collections\Collection
     *
     * @ORM\OneToMany(targetEntity="App\Entity\Type", mappedBy="account", cascade={"persist"}, fetch="EXTRA_LAZY")
     */
     ...
     * @var \Doctrine\Common\Collections\Collection
     *
     * @ORM\OneToMany(targetEntity="App\Entity\Tag", mappedBy="account", cascade={"persist"}, fetch="EXTRA_LAZY")
     * @ORM\OrderBy({"tag" = "ASC"})
     */
    protected $tags;
     ...
     * @var \Doctrine\Common\Collections\Collection
     *
     * @ORM\OneToMany(targetEntity="App\Entity\Equipment", mappedBy="account", cascade={"persist"}, fetch="EXTRA_LAZY")
     */
    protected $equipment;
     ...
     * @var \Doctrine\Common\Collections\Collection
     *
     * @ORM\OneToMany(targetEntity="App\Entity\EquipmentType", mappedBy="account", cascade={"persist"}, fetch="EXTRA_LAZY")
     */
