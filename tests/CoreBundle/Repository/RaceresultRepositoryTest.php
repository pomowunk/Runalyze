...
class RaceresultRepositoryTest extends AbstractRepositoryTestCase
{
    ...
    public function testSingleRace()
    {
        ...
        $this->assertFalse($this->getContainer()->get('Runalyze\Bundle\CoreBundle\Services\Recalculation\RecalculationManager')->isTaskScheduled($this->Account, VO2maxCorrectionFactorCalculation::class));
    }
    ...
    public function testFindingVO2maxCorrectionFactorForSingleRace()
    {
        ...
        $this->assertTrue($this->getContainer()->get('Runalyze\Bundle\CoreBundle\Services\Recalculation\RecalculationManager')->isTaskScheduled($this->Account, VO2maxCorrectionFactorCalculation::class));
    }
