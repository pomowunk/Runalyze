...
return array(
    'Ajax' => $baseDir . '/inc/html/class.Ajax.php',
    'BoxedValue' => $baseDir . '/inc/html/class.BoxedValue.php',
    'Cache' => $baseDir . '/inc/system/class.Cache.php',
    'Collator' => $vendorDir . '/symfony/symfony/src/Symfony/Component/Intl/Resources/stubs/Collator.php',
    'Composer\\InstalledVersions' => $vendorDir . '/composer/InstalledVersions.php',
    'ConfigTab' => $baseDir . '/inc/system/config/class.ConfigTab.php',
    'ConfigTabGeneral' => $baseDir . '/inc/system/config/class.ConfigTabGeneral.php',
    'ConfigTabPlugins' => $baseDir . '/inc/system/config/class.ConfigTabPlugins.php',
    'ConfigTabs' => $baseDir . '/inc/system/config/class.ConfigTabs.php',
    'DB' => $baseDir . '/inc/system/class.DB.php',
    'DataBrowser' => $baseDir . '/inc/class.DataBrowser.php',
    'DataBrowserLinker' => $baseDir . '/inc/class.DataBrowserLinker.php',
    'DataBrowserShared' => $baseDir . '/inc/class.DataBrowserShared.php',
    'ElevationInfo' => $baseDir . '/inc/training/view/class.ElevationInfo.php',
    'Formular' => $baseDir . '/inc/html/formular/class.Formular.php',
    'FormularCheckbox' => $baseDir . '/inc/html/formular/class.FormularCheckbox.php',
    'FormularField' => $baseDir . '/inc/html/formular/class.FormularField.php',
    'FormularFieldset' => $baseDir . '/inc/html/formular/class.FormularFieldset.php',
    'FormularInput' => $baseDir . '/inc/html/formular/class.FormularInput.php',
    'FormularInputDate' => $baseDir . '/inc/html/formular/class.FormularInputDate.php',
    'FormularInputHidden' => $baseDir . '/inc/html/formular/class.FormularInputHidden.php',
    'FormularInputNumber' => $baseDir . '/inc/html/formular/class.FormularInputNumber.php',
    'FormularInputSearchTimeRange' => $baseDir . '/inc/training/search/class.FormularInputSearchTimeRange.php',
    'FormularInputWithEqualityOption' => $baseDir . '/inc/html/formular/class.FormularInputWithEqualityOption.php',
    'FormularSelectBox' => $baseDir . '/inc/html/formular/class.FormularSelectBox.php',
    'FormularSelectDb' => $baseDir . '/inc/html/formular/class.FormularSelectDb.php',
    'FormularSelectSearchSort' => $baseDir . '/inc/training/search/class.FormularSelectSearchSort.php',
    'FormularSubmit' => $baseDir . '/inc/html/formular/class.FormularSubmit.php',
    'FormularTextarea' => $baseDir . '/inc/html/formular/class.FormularTextarea.php',
    'FormularUnit' => $baseDir . '/inc/html/formular/class.FormularUnit.php',
    'FormularValueParser' => $baseDir . '/inc/html/formular/class.FormularValueParser.php',
    'Frontend' => $baseDir . '/inc/class.Frontend.php',
    'FrontendShared' => $baseDir . '/inc/class.FrontendShared.php',
    'FrontendSharedList' => $baseDir . '/inc/class.FrontendSharedList.php',
    'FrontendSharedStatistics' => $baseDir . '/inc/class.FrontendSharedStatistics.php',
    'HTML' => $baseDir . '/inc/html/class.HTML.php',
    'Helper' => $baseDir . '/inc/class.Helper.php',
    'HtmlTag' => $baseDir . '/inc/html/class.HtmlTag.php',
    'Icon' => $baseDir . '/inc/html/class.Icon.php',
    'ImporterWindow' => $baseDir . '/inc/import/class.ImporterWindow.php',
    ...
    'PDOforRunalyze' => $baseDir . '/inc/system/class.PDOforRunalyze.php',
    ...
    'Plot' => $baseDir . '/inc/draw/class.Plot.php',
    'PlotMonthSumData' => $baseDir . '/inc/draw/class.PlotMonthSumData.php',
    'PlotSumData' => $baseDir . '/inc/draw/class.PlotSumData.php',
    'PlotWeekSumData' => $baseDir . '/inc/draw/class.PlotWeekSumData.php',
    'Plugin' => $baseDir . '/inc/plugin/class.Plugin.php',
    'PluginConfiguration' => $baseDir . '/inc/plugin/config/class.PluginConfiguration.php',
    'PluginConfigurationValue' => $baseDir . '/inc/plugin/config/class.PluginConfigurationValue.php',
    'PluginConfigurationValueArray' => $baseDir . '/inc/plugin/config/class.PluginConfigurationValueArray.php',
    'PluginConfigurationValueBool' => $baseDir . '/inc/plugin/config/class.PluginConfigurationValueBool.php',
    'PluginConfigurationValueDistance' => $baseDir . '/inc/plugin/config/class.PluginConfigurationValueDistance.php',
    'PluginConfigurationValueDistances' => $baseDir . '/inc/plugin/config/class.PluginConfigurationValueDistances.php',
    'PluginConfigurationValueFloat' => $baseDir . '/inc/plugin/config/class.PluginConfigurationValueFloat.php',
    'PluginConfigurationValueHiddenArray' => $baseDir . '/inc/plugin/config/class.PluginConfigurationValueHiddenArray.php',
    'PluginConfigurationValueInt' => $baseDir . '/inc/plugin/config/class.PluginConfigurationValueInt.php',
    'PluginConfigurationValueSelect' => $baseDir . '/inc/plugin/config/class.PluginConfigurationValueSelect.php',
    'PluginConfigurationWindow' => $baseDir . '/inc/plugin/config/class.PluginConfigurationWindow.php',
    'PluginFactory' => $baseDir . '/inc/plugin/class.PluginFactory.php',
    'PluginInstaller' => $baseDir . '/inc/plugin/class.PluginInstaller.php',
    'PluginPanel' => $baseDir . '/inc/plugin/class.PluginPanel.php',
    'PluginStat' => $baseDir . '/inc/plugin/class.PluginStat.php',
    'PluginType' => $baseDir . '/inc/plugin/class.PluginType.php',
    'Prognose_PrognosisWindow' => $baseDir . '/plugin/RunalyzePluginPanel_Prognose/class.Prognose_PrognosisWindow.php',
    'ProgressBar' => $baseDir . '/inc/html/class.ProgressBar.php',
    'ProgressBarSingle' => $baseDir . '/inc/html/class.ProgressBarSingle.php',
    'Request' => $baseDir . '/inc/system/class.Request.php',
    'RunalyzePluginPanel_Equipment' => $baseDir . '/plugin/RunalyzePluginPanel_Equipment/class.RunalyzePluginPanel_Equipment.php',
    'RunalyzePluginPanel_Prognose' => $baseDir . '/plugin/RunalyzePluginPanel_Prognose/class.RunalyzePluginPanel_Prognose.php',
    'RunalyzePluginPanel_Rechenspiele' => $baseDir . '/plugin/RunalyzePluginPanel_Rechenspiele/class.RunalyzePluginPanel_Rechenspiele.php',
    'RunalyzePluginPanel_Sportler' => $baseDir . '/plugin/RunalyzePluginPanel_Sportler/class.RunalyzePluginPanel_Sportler.php',
    'RunalyzePluginPanel_Sports' => $baseDir . '/plugin/RunalyzePluginPanel_Sports/class.RunalyzePluginPanel_Sports.php',
    'RunalyzePluginPanel_TagsSummary' => $baseDir . '/plugin/RunalyzePluginPanel_TagsSummary/class.RunalyzePluginPanel_TagsSummary.php',
    'RunalyzePluginPanel_Ziele' => $baseDir . '/plugin/RunalyzePluginPanel_Ziele/class.RunalyzePluginPanel_Ziele.php',
    'RunalyzePluginStat_Analyse' => $baseDir . '/plugin/RunalyzePluginStat_Analyse/class.RunalyzePluginStat_Analyse.php',
    'RunalyzePluginStat_Hoehenmeter' => $baseDir . '/plugin/RunalyzePluginStat_Hoehenmeter/class.RunalyzePluginStat_Hoehenmeter.php',
    'RunalyzePluginStat_MonthlyStats' => $baseDir . '/plugin/RunalyzePluginStat_MonthlyStats/class.RunalyzePluginStat_MonthlyStats.php',
    'RunalyzePluginStat_Rekorde' => $baseDir . '/plugin/RunalyzePluginStat_Rekorde/class.RunalyzePluginStat_Rekorde.php',
    'RunalyzePluginStat_Statistiken' => $baseDir . '/plugin/RunalyzePluginStat_Statistiken/class.RunalyzePluginStat_Statistiken.php',
    'RunalyzePluginStat_Strecken' => $baseDir . '/plugin/RunalyzePluginStat_Strecken/class.RunalyzePluginStat_Strecken.php',
    'RunalyzePluginStat_Tag' => $baseDir . '/plugin/RunalyzePluginStat_Tag/class.RunalyzePluginStat_Tag.php',
    'RunalyzePluginStat_Trainingspartner' => $baseDir . '/plugin/RunalyzePluginStat_Trainingspartner/class.RunalyzePluginStat_Trainingspartner.php',
    'RunalyzePluginStat_Trainingszeiten' => $baseDir . '/plugin/RunalyzePluginStat_Trainingszeiten/class.RunalyzePluginStat_Trainingszeiten.php',
    'RunalyzePluginStat_Wetter' => $baseDir . '/plugin/RunalyzePluginStat_Wetter/class.RunalyzePluginStat_Wetter.php',
    'RunalyzePluginStat_Wettkampf' => $baseDir . '/plugin/RunalyzePluginStat_Wettkampf/class.RunalyzePluginStat_Wettkampf.php',
    'Runalyze\\Plugin\\Stat\\Wetter\\MinMaxTableForEquipment' => $baseDir . '/plugin/RunalyzePluginStat_Wetter/MinMaxTableForEquipment.php',
    'Runalyze\\Plugin\\Stat\\Wetter\\MonthwiseTable' => $baseDir . '/plugin/RunalyzePluginStat_Wetter/MonthwiseTable.php',
    'Runalyze\\Plugin\\Statistic\\Races\\RaceContainer' => $baseDir . '/plugin/RunalyzePluginStat_Wettkampf/RaceContainer.php',
    'SearchFormular' => $baseDir . '/inc/training/search/class.SearchFormular.php',
    'SearchLink' => $baseDir . '/inc/training/search/class.SearchLink.php',
    'SearchResults' => $baseDir . '/inc/training/search/class.SearchResults.php',
    ...
    'SectionComposite' => $baseDir . '/inc/training/view/section/class.SectionComposite.php',
    'SectionCompositeRow' => $baseDir . '/inc/training/view/section/class.SectionCompositeRow.php',
    'SectionHRV' => $baseDir . '/inc/training/view/section/class.SectionHRV.php',
    'SectionHRVRow' => $baseDir . '/inc/training/view/section/class.SectionHRVRow.php',
    'SectionHeartrate' => $baseDir . '/inc/training/view/section/class.SectionHeartrate.php',
    'SectionHeartrateRow' => $baseDir . '/inc/training/view/section/class.SectionHeartrateRow.php',
    'SectionLaps' => $baseDir . '/inc/training/view/section/class.SectionLaps.php',
    'SectionLapsRowComputed' => $baseDir . '/inc/training/view/section/class.SectionLapsRowComputed.php',
    'SectionLapsRowManual' => $baseDir . '/inc/training/view/section/class.SectionLapsRowManual.php',
    'SectionMiscellaneous' => $baseDir . '/inc/training/view/section/class.SectionMiscellaneous.php',
    'SectionMiscellaneousRow' => $baseDir . '/inc/training/view/section/class.SectionMiscellaneousRow.php',
    'SectionOverview' => $baseDir . '/inc/training/view/section/class.SectionOverview.php',
    'SectionOverviewRow' => $baseDir . '/inc/training/view/section/class.SectionOverviewRow.php',
    'SectionPace' => $baseDir . '/inc/training/view/section/class.SectionPace.php',
    'SectionPaceRow' => $baseDir . '/inc/training/view/section/class.SectionPaceRow.php',
    'SectionRoute' => $baseDir . '/inc/training/view/section/class.SectionRoute.php',
    'SectionRouteOnlyElevation' => $baseDir . '/inc/training/view/section/class.SectionRouteOnlyElevation.php',
    'SectionRouteOnlyMap' => $baseDir . '/inc/training/view/section/class.SectionRouteOnlyMap.php',
    'SectionRouteRowElevation' => $baseDir . '/inc/training/view/section/class.SectionRouteRowElevation.php',
    'SectionRouteRowMap' => $baseDir . '/inc/training/view/section/class.SectionRouteRowMap.php',
    'SectionRunScribeData' => $baseDir . '/inc/training/view/section/class.SectionRunScribeData.php',
    'SectionRunScribeDataRow' => $baseDir . '/inc/training/view/section/class.SectionRunScribeDataRow.php',
    'SectionRunningDynamics' => $baseDir . '/inc/training/view/section/class.SectionRunningDynamics.php',
    'SectionRunningDynamicsRow' => $baseDir . '/inc/training/view/section/class.SectionRunningDynamicsRow.php',
    'SectionSwimLane' => $baseDir . '/inc/training/view/section/class.SectionSwimLane.php',
    'SectionSwimLaneRow' => $baseDir . '/inc/training/view/section/class.SectionSwimLaneRow.php',
    'SessionAccountHandler' => $baseDir . '/inc/system/class.SessionAccountHandler.php',
    'SharedLinker' => $baseDir . '/inc/system/class.SharedLinker.php',
    'Splits' => $baseDir . '/inc/data/class.Splits.php',
    'Sport' => $baseDir . '/inc/data/class.Sport.php',
    'SportFactory' => $baseDir . '/inc/data/class.SportFactory.php',
    'SqlFormatter' => $vendorDir . '/jdorn/sql-formatter/lib/SqlFormatter.php',
    'SummaryTable' => $baseDir . '/plugin/RunalyzePluginStat_Statistiken/class.SummaryTable.php',
    'SummaryTable10Weeks' => $baseDir . '/plugin/RunalyzePluginStat_Statistiken/class.SummaryTable10Weeks.php',
    'SummaryTableAllWeeks' => $baseDir . '/plugin/RunalyzePluginStat_Statistiken/class.SummaryTableAllWeeks.php',
    'SummaryTableAllYears' => $baseDir . '/plugin/RunalyzePluginStat_Statistiken/class.SummaryTableAllYears.php',
    'SummaryTableMonths' => $baseDir . '/plugin/RunalyzePluginStat_Statistiken/class.SummaryTableMonths.php',
    'System' => $baseDir . '/inc/system/class.System.php',
    ...
    'TrainingSelectWeather' => $baseDir . '/inc/training/formular/class.TrainingSelectWeather.php',
    'TrainingView' => $baseDir . '/inc/training/view/class.TrainingView.php',
    'TrainingViewSection' => $baseDir . '/inc/training/view/class.TrainingViewSection.php',
    'TrainingViewSectionRow' => $baseDir . '/inc/training/view/class.TrainingViewSectionRow.php',
    'TrainingViewSectionRowAbstract' => $baseDir . '/inc/training/view/class.TrainingViewSectionRowAbstract.php',
    'TrainingViewSectionRowFullwidth' => $baseDir . '/inc/training/view/class.TrainingViewSectionRowFullwidth.php',
    'TrainingViewSectionRowOnlyText' => $baseDir . '/inc/training/view/class.TrainingViewSectionRowOnlyText.php',
    'TrainingViewSectionRowTabbedPlot' => $baseDir . '/inc/training/view/class.TrainingViewSectionRowTabbedPlot.php',
    'TrainingViewSectionTabbed' => $baseDir . '/inc/training/view/class.TrainingViewSectionTabbed.php',
    'TrainingViewSectionTabbedPlot' => $baseDir . '/inc/training/view/class.TrainingViewSectionTabbedPlot.php',
);
